...
class AddHappyPlaceActivity : AppCompatActivity(), View.OnClickListener {
    ...
    // TODO(Step 4: Create a method or let say function to request the current location. Using the fused location provider client.)
    // START
    /**
        ...
        when (v!!.id) {
            ...
            R.id.tv_select_current_location->{
                if(!isLocationEnabled()){
                    Toast.makeText(this,"Please turn on ur location",
